...
Aircraft.Specs.Performance.EtaOv = 2.07;
...
% cruise speed (mach)
Aircraft.Specs.Performance.Vels.Crs = 30/343;
...
Aircraft.Specs.Weight.MTOW = 42;

% block fuel weight (kg)
Aircraft.Specs.Weight.Fuel = 9;

% battery weight (kg)
Aircraft.Specs.Weight.Batt = 0;

% OEW (kg)
Aircraft.Specs.Weight.OEW = 23;
...
Aircraft.Specs.Propulsion.SFC = 0.36;
