function [Aircraft] = ERJ175LR_PHE()
%
% [Aircraft] = ERJ175LR()
...
Aircraft.Specs.Power.LamDwn.SLS = 0.085;
Aircraft.Specs.Power.LamDwn.Tko = 0.085;
...
Aircraft.Specs.Power.LamUps.SLS = 0.085;
Aircraft.Specs.Power.LamUps.Tko = 0.085;
