function [Aircraft] = ScanEagle()
%
% [Aircraft] = ScanEagle()
% written by emma cassidy, emmasmit@umich.edu
% last updated: 24 apr 2026
% 
% spec file to model Boeing Insitu ScanEagle UAV
%
% INPUTS:
%     none
%
...
% % ** required **
% payload (kg)
Aircraft.Specs.Weight.Payload = 2.5;
...
Aircraft.Specs.Weight.WairfCF = 1.04;
...
% cruise speed (mach)
Aircraft.Specs.Performance.Vels.Crs = 25/343;

% cruise altitude (m)
Aircraft.Specs.Performance.Alts.Crs = 4000;

% endurance (min)
Aircraft.Specs.Performance.Endurance = 24*60;
...
Aircraft.Specs.Weight.MTOW = 20;

% block fuel weight (kg)
Aircraft.Specs.Weight.Fuel = 4.5;

% battery weight (kg)
Aircraft.Specs.Weight.Batt = 0;

% OEW (kg)
Aircraft.Specs.Weight.OEW = 13.1;
...
Aircraft.Specs.Propulsion.SFC = 0.12;
