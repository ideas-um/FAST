...
elseif (Type == 1)
    ...
    G = ConstraintDiagramPkg.Sigmoid(Aircraft, 0.5337, -19.6881, 0.5987, 1.1878);
...
elseif (ReqType == 2)
    ...
    % throw error
    error("ERROR - Jet25_121c: ReqType must be either 0 (Roskam), 1 (Mattingly), or 2 (de Vries et al.).");
