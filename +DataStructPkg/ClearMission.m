...
if (ielem == 0)
    ...
    Aircraft.Mission.History.SI.Power.Pav(     :, :) = 0;
    Aircraft.Mission.History.SI.Power.Preq(    :, :) = 0;
    Aircraft.Mission.History.SI.Power.Tav(     :, :) = 0;
    Aircraft.Mission.History.SI.Power.Treq(    :, :) = 0;
    Aircraft.Mission.History.SI.Power.Pout(    :, :) = 0;
    Aircraft.Mission.History.SI.Power.Tout(    :, :) = 0;
    ...
    Aircraft.Mission.History.SI.Power.Pav(     ielem:end, :) = 0;
    Aircraft.Mission.History.SI.Power.Preq(    ielem:end, :) = 0;
    Aircraft.Mission.History.SI.Power.Tav(     ielem:end, :) = 0;
    Aircraft.Mission.History.SI.Power.Treq(    ielem:end, :) = 0;
    Aircraft.Mission.History.SI.Power.Pout(    ielem:end, :) = 0;
    Aircraft.Mission.History.SI.Power.Tout(    ielem:end, :) = 0;
