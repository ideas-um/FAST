...
% Laboratory
% 
% Engine Cycle Model Package (+EngineModelPkg/+CycleModelPkg)
%
...
% (I) Overview
%
%       The cycle model package contains the thermodynamic cycle drivers
%       which design an engine given engine specifications and a known air
%       mass flow rate. These cycles are called in a sizing loop to meet
%       thrust or power performance.
% 
% -------------------------------------------------------------------------
% (II) Warning
%
...
% -------------------------------------------------------------------------
%
% end EngineModelPkg.CycleModelPkg.README
%
end