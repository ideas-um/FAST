...
% Laboratory
% 
% Mission Segments Package (+MissionSegsPkg)
%
...
% (I) Overview
%
%       The Mission Segments Package is responsible for all aircraft
%       performance-related functionality while performing the mission
%       analysis (i.e., processing and flying the mission).
% 
% -------------------------------------------------------------------------
% (II) Warning
%
