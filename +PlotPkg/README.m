...
% (I) Overview
%
%       The Plotting Package is responsible for plotting the mission
%       history upon the user's request. It creates subplots to show the
%       time-based history of multiple aircraft performance and
