...
% (I) Overview
%
%       The Projection Package is used to predict the values of certain Key
%       Performance Parameters (KPPs) into the future, such as battery
%       specific energy, cruise SFC, OEW/MTOW, and more. These projections
%       are used in FAST when the user doesn't prescribe information about
%       them.
% 
% -------------------------------------------------------------------------
% (II) Warning
