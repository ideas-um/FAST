...
% Laboratory
% 
% Propulsion Package (+PropulsionPkg)
%
...
% (I) Overview
%
%       The Propulsion Package is responsible for creating the user's
%       desired propulsion architecture and evaluating the propulsion
%       system's performance during the mission analysis. It connects to
%       the EngineModelPkg for evaluating an actual engine's performance.
% 
% -------------------------------------------------------------------------
% (II) Warning
%
