...
% regional jet). Instead of climbing and accelerating towards cruise
% altitude, finish the climb and then accelerate.
% 
...
% start/end of constant EAS climb/descent
...
VelDes = UnitConversionPkg.ConvVel(210, "kts", "m/s"); % EAS
...
Mission.AltBeg = [AltTko; AltTko;     AltClb;     AltCrs; AltCrs;     AltCrs;     AltCrs;    AltClb; ResAltBeg;     ResAltClb; ResAltClb2Crs; ResAltCrs; ResAltCrs;     ResAltCrs; ResAltClb2Crs; ResAltClb; AltTko;];
Mission.AltEnd = [AltTko; AltClb;     AltCrs;     AltCrs; AltCrs;     AltCrs;     AltClb; ResAltBeg; ResAltClb; ResAltClb2Crs;     ResAltCrs; ResAltCrs; ResAltCrs; ResAltClb2Crs;     ResAltClb;    AltTko; AltTko;];
