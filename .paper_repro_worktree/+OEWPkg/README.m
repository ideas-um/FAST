...
% (I) Overview
%
%       The OEW Package is responsible for determining the aircraft's
%       airframe and propulsion system weights. This functionality only
%       occurs during aircraft sizing (when
%       "Aircraft.Settings.Analysis.Type" is set to +1).
% 
% -------------------------------------------------------------------------
% (II) Warning
%
