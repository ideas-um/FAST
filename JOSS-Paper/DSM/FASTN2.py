...
class FAST(om.Group):
    ...
    def setup(self):
        ...
        # add the subsystems
        self.add_subsystem("Initialization", FM.Initialization(), promotes_inputs=[("A/C_Specs", "A/C_Specs"), ("Mission_Profile", "Mission_Profile"), ("Run_Settings", "Run_Settings")],promotes_outputs=[("Processed_Specifications")])
